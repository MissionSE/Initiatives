...
public class CorrelateSources {
	 ...
	 * by the parser.
	 */
	public SourceDataModel correlateSources(ArrayList<SourceDataModel> sources, String id) {
		if (sources.size() == 1) {
		...
		return cfp.correlateSources(toCorrelate, id);
