...
$(document).ready(function () {
    var displaylimit = 10;
    var twitterprofile = "wganley";
    var screenname = "Bill Ganley";
    ...
    $.getJSON('http://localhost:8888/earth/getTweets1.1.php',
        function(feeds) {
            var feedHTML = '';
