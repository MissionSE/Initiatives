    ...
    for ($i = 0; $i < $count; $i++) {
        ...
        if ($tweetid > 0) {
            ...
            if ($rows > 0) {
                ...
                $updateQuery = "UPDATE tweets SET tweetid = '$tweetid', location = '$location', username = $username, text = '$text' WHERE tweetid = $tweetid";
            ...
            //New tweet
                ...
                $insertQuery = "INSERT INTO tweets (tweetid, location, username, text) VALUES ('$tweetid','$location','$username','$text')";
