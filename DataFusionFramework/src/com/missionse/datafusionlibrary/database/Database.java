...
import com.missionse.datafusionlibrary.Source;
...
public final class Database {
    ...
    public ArrayList<String> fetchUniqueId() throws SQLException {
        ...
        String query = "SELECT uniqueId FROM staticInfo";
     ...
     * database occurs.
     */
    public void updateBuilder(Source source) throws SQLException {
        ...
        String staticExist = "SELECT * FROM staticInfo WHERE uniqueId = ?";
        ...
        if (counter < 1) {
            ...
            //Static Information
            String staticQuery = "INSERT INTO staticInfo("
                    + "uniqueId,"
                    + "trackType, "
                    + "trackPlatform,"
                    + "trackCategory)"
            ...
            //same uniqueId.
            String query = "UPDATE staticInfo"
                    + " SET trackType=?, "
                    + "trackPlatform=?, "
                    + "trackCategory=?";
